...
def consultar_gemini(prompt_usuario, df_inventario, texto_pdfs):
    ...
    Siempre sugiere una pregunta de seguimiento para profundizar en el tema.
    ...
    Si la pregunta del usuario tiene relación con cuantificar productos y datos del inventario, entrega la respuesta en forma de tabla siempre que pidan dos o mas datos de producto, 
    y en forma de lista si te piden un solo dato de cada producto.
